...
void HTTPSSession::run() {
  ...
  boost::asio::dispatch(stream_.get_executor(),
                        boost::beast::bind_front_handler(&HTTPSSession::on_run,
                                                         shared_from_this()));
}
...
void HTTPSSession::do_read() {
  ...
  boost::beast::http::async_read(
      ...
      boost::beast::bind_front_handler(&HTTPSSession::on_read,
                                       shared_from_this()));
}

void HTTPSSession::on_read(boost::beast::error_code ec,
...
void HTTPSSession::on_write(bool close, boost::beast::error_code ec,
                            std::size_t bytes_transferred) {
  boost::ignore_unused(bytes_transferred);

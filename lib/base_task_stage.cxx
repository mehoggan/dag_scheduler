...
namespace com
{
  namespace dag_scheduler
  {
    ...
    BaseTaskStage::BaseTaskStage(const std::string &label) :
      label_(label)
    {}
      ...
      uuid_(std::move(other.uuid_))
    {
      assert(not other.is_running() &&
        "You cannot move a running BaseTaskStage");
    }
    ...
    const std::string &BaseTaskStage::label() const
    {
      return label_;
    }

    const UUID &BaseTaskStage::get_uuid() const
    {
      return uuid_;
    }

    bool BaseTaskStage::run()
    {
      return true;
    }

    bool BaseTaskStage::is_running() const
    {
      return false;
    }

    bool BaseTaskStage::end()
    {
      return false;
    }

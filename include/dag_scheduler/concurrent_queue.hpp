...
namespace com
{
  namespace dag_scheduler
  {
    ...
    public:
       ...
       * @brief Default ctor.
       *
       * Will assert if \ref DataType is non-movable.
       */
      concurrent_queue()
      {
       ...
       * number is not safe.
       *
       * @return The number of elements of type \ref DataType contained in
       *         the queue.
       */
      std::size_t size()
      {
      ...
      /**
       * @brief A function that removes \ref DataType from queue if it is not
       *        empty.
       *
       ...
       * @param popped_value[out] The \ref DataType to assign to if queue is
       *                          NOT empty.
      ...
      /**
       * @brief A function that prints the content of the queue at a specific
       *        time.
       *
       ...
       *
       * @param[out] out The stream to write the contents to.
       * @param[in] q The \ref concurrent_queue<DataType> for which to print
       *              its contents.
       *

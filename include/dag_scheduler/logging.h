...
{
  template<>
  struct hash<com::dag_scheduler::LogTag>
  {
...
namespace com
{
  namespace dag_scheduler
  {
    ...
    public:
       ...
       *         otherwise.
       */
      static bool add_std_cout_logger(const LogTag &tag,
       ...
       *         otherwise.
       */
      static bool add_std_cerr_logger(const LogTag &tag,
       ...
       *         otherwise.
       */
      static bool add_std_log_logger(const LogTag &tag,
       ...
       * @return 
       */
      static bool add_file_logger(const LogTag &tag,
     ...
     */
    template <class T>
    LogTag add_std_cout_std_err_logger_for_type_instance(const T &t,

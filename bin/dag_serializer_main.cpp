...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()(
      "dag_yaml", boost::program_options::value<std::string>()->required(),
      "Absolute path to dag.yml (dag.yaml) file.")("help", help_string.c_str());
  ...
  if (vm.count("help")) {
    ...
    try {
      ...
      com::dag_scheduler::Logging::info(LOG_TAG, "Deserialized YAML file.");
